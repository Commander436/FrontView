...
export function ScopeOverlay({ mode }: ScopeOverlayProps) {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-30 overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" style={{ width: '71vmin', height: '71vmin' }}>
      ...
      {/* Grain for NVG */}
      {mode === 'nvg' && (
        <div className="absolute inset-0 nvg-grain opacity-[0.06]" />
      )}
      ...
      {mode === 'flir' && (
        <div
          ...
          style={{
            background: 'linear-gradient(180deg, rgba(80,0,120,0.3) 0%, rgba(200,50,0,0.2) 50%, rgba(255,200,0,0.1) 100%)',
